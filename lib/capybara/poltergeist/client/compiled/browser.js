Poltergeist.Browser = (function() {
  ...
  Browser.prototype.wait = function(script) {
    if (this.page.evaluate("function() { return " + script + " }")) {
      return this.sendResponse(true);
    } else {
      return setTimeout(((function(_this) {
        return function() {
          return _this.wait(script);
        };
      })(this)), 50);
    }
  };

  Browser.prototype.callback = function(script) {
    this.page["native"].onCallback = (function(_this) {
      return function(script) {
        _this.page["native"].onCallback = null;
        return _this.sendResponse(data);
      };
    })(this);
    return this.page.execute("function() { " + script + " }");
  };
